...
describe('Progressive form', () => {
  ...
  it('Has labels', async () => {
    ...
    expect( await page.evaluate( 'FormUp.getLabel.aria( "#input-4" )' )).toBe( 'Text w/ placeholder' )
    expect( await page.evaluate( 'FormUp.getLabel.aria( "#input-5" )' )).toBe( 'Phone number' )
  })
})
